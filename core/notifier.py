...
def _build_keyboard(user: User, listing: Listing, lang: str) -> InlineKeyboardMarkup:
    ...
    # No contact button shown — contact info intentionally excluded from alerts for all languages
    row2 = [InlineKeyboardButton(t("btn_save_listing", lang), callback_data=f"save_listing_{listing.id}")]
